...
export class FormatExcelLastVoyageService {
  ...
  async GenerateFormatObjForExcelEmail(
    listGetReportVoyagePortDaily: GetReportVoyagePortDaily[],
    getInfoFuelStartEndByFilterDate: InfoFuelStartEndForDate,
    selectUser: UserEntity,
  ): Promise<GenerateFormatObjForExcelEmail> {
    ...
    return await DummyPromise()
      ...
      .then(result => {
        ...
        this.AddInfoByPortAccordingToTheTravelreport(
          workbook,
          2,
          10,
          new UserEntity(),
  ...
  private async GenerarHojaDataReport(
    worksheet: Worksheet,
    listGetReportVoyagePortDaily: GetReportVoyagePortDaily[],
    getInfoFuelStartEndByFilterDate: InfoFuelStartEndForDate,
    selectUser: UserEntity,
  ): Promise<MailLastVoyage> {
    // reset colum
    ...
    positionColumn = 7;
    let tamanioInfoVessel = this.StyleDashInfoVessel(
      worksheet,
      positionRow,
      positionColumn,
      selectUser,
      infoVessel,
      posicionDelosRegistrosNormales,
      posicionDelosRegistrosActivitPerforment,
    );
    ...
    let objMailLastVoyage: MailLastVoyage = this.StyleDashReportRegister(
      worksheet,
      positionRow,
      selectUser,
      listGetReportVoyagePortDaily,
      posicionDelInfoVessel,
    );
  ...
  private StyleDashInfoVessel(
    ...
    posicionDelosRegistrosNormales: PosicionDelosRegistrosNormales,
    posicionDelosRegistrosActivitPerforment: PosicionDelosRegistrosNormales,
  ): number {
    let colorYellowTransgas = 'FFCD06';
    // Variables de colores-
    let blueHard = '001556';
    ...
    let tamanioActivityMGO = this.StyleDashActivity(
      worksheet,
      positionRows,
      positionColumn,
      selectUser,
  ...
  private StyleDashSpeed(
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      isIFOorMGO == 'IFO' ? textIFOorVLSFOorLSFO : 'MGO',
      10,
      colorYellowTransgas,
      blueHard3,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.contractSpeedSailingBallastIFO : selectUser.contractSpeedSailingBallastMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.contractSpeedSailingEconomicalIFO : selectUser.contractSpeedSailingEconomicalMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.contractSpeedSailingLadenIFO : selectUser.contractSpeedSailingLadenMGO),
      8,
      black,
      white,
      '',
  ...
  private StyleDashActivity(
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.loadingConsumptionIFO : selectUser.loadingConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      {
        formula:
          isIFOorMGO == 'IFO' ? 'Z' + posicionDelosRegistrosActivitPerforment.startRow : 'BN' + posicionDelosRegistrosActivitPerforment.startRow,
      },
      8,
      black,
      white,
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.dischargeConsumptionIFO : selectUser.dischargeConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.sailingBallastConsumptionIFO : selectUser.sailingBallastConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.sailingLoadConsumptionIFO : selectUser.sailingLoadConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.sailingEconomicConsumptionIFO : selectUser.sailingEconomicConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.anchoredConsumptionIFO : selectUser.anchoredConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.maneuverConsumptionIFO : selectUser.maneuverConsumptionMGO),
      8,
      black,
      white,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(isIFOorMGO == 'IFO' ? selectUser.otherConsumptionIFO : selectUser.otherConsumptionMGO),
      8,
      black,
      white,
      '',
  ...
  private StyleDashCosumption(
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      'VESSEL PERFORMANCE ' + (isIFOorMGO == 'IFO' ? textIFOorVLSFOorLSFO : 'MGO'),
      20,
      colorYellowTransgas,
      blueHard3,
      '',
    ...
    this.addStyleByColums(
      ...
      positionRows,
      positionColumns,
      Number(Number(isIFOorMGO == 'IFO' ? selectUser.anchoredConsumptionIFO : selectUser.anchoredConsumptionMGO)),
      8,
      black,
      white,
      '',
    ...
    listGetReportVoyagePortDaily.forEach((getReportVoyagePortDaily, index) => {
      ...
      if (primerNuevoPuerto) {
        ...
        this.addStyleByColums(
          ...
          positionRows,
          positionColumns,
          ConvertDateUTC_To_FORMAT_UTC(itemReportBefore.date) + ' GMT',
          8,
          black,
          white,
          '',
      ...
      if (
        ...
        this.addStyleByColums(
          ...
          positionRows,
          positionColumns,
          getReportVoyagePortDaily.distance ? getReportVoyagePortDaily.distance : '',
          8,
          black,
          white,
          '',
      ...
      worksheetPuerto.getCell(this.PositByCell(refreshFecha.colum) + refreshFecha.row).value =
        ConvertDateUTC_To_FORMAT_UTC(getReportVoyagePortDaily.date) + ' GMT';
  ...
  private cuadroResumentotal(
    contadorDeItemPorPuerto: number,
    positionRow: number,
    columReset: number,
    worksheetPuerto: Worksheet,
    lastRow: number,
    firstROB: any,
    lastROB: any,
    firshRow: number,
  ...
  private StyleDashReportRegister(
    ...
    selectUser: UserEntity,
    listGetReportVoyagePortDaily: GetReportVoyagePortDaily[],
    posicionDelInfoVessel: PosicionDelosRegistrosNormales,
  ): MailLastVoyage {
    // Colores amarillo
    let colorYellowTransgas = 'FFCD06';
    // Variables de colores-
    ...
    worksheet.getCell('BE' + positionRow).value = <any>{
    ...
    worksheet.getCell('BY' + positionRow).value = <any>{
    ...
    listGetReportVoyagePortDaily.forEach((getReportVoyagePortDaily, index) => {
      ...
      // Sumamaos el total
      let sumaTotalIFO =
        getReportVoyagePortDaily.mplaIfo + getReportVoyagePortDaily.auxIfo + getReportVoyagePortDaily.boilerIfo + getReportVoyagePortDaily.otherIfo;
      ...
      if (index == 0) {
        ...
        worksheet.getCell('BF' + positionRow).value = <any>{
          formula: 'BE' + (positionRow - 2) + '-AZ' + positionRow + '+BD' + positionRow,
        };
        worksheet.getCell('BZ' + positionRow).value = <any>{
  ...
  private addStyleByColums(
    ...
    position: number[],
    column: number[],
    textorFormule: string | number | any,
    sizeFont: number,
    colortText: string,
...
export class PosicionDelosRegistrosNormales {
  constructor(public startRow?: number, public endRow?: number, public startColum?: number) {
...
export class GenerateFormatObjForExcelEmail {
  constructor(public success?: boolean, public buffer?: Buffer, public objMailLastVoyage?: MailLastVoyage) {
