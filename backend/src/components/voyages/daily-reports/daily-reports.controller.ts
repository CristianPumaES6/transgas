...
export class DailyReportsController {
  constructor(private readonly _dailyReportsService: DailyReportsService) {}
 ...
 */
  ...
  GetInfoVoyageROBAndBunkeringByBuqueAndDate(
    @Headers() headers,
    @Param('userId') userId: number,
    @Param('startDate') startDate: Date,
    @Param('endDate') endDate: Date,
    ...
    return DummyPromise()
      ...
      .then((results: GetInfoVoyageROBBunkering[]) => {
        // Retornamos una Respuesta exitosa.
        return {
          status: HttpStatus.OK,
          message: 'OK',
  ...
  GetReportVoyagePortDaily(
    ...
    return DummyPromise()
      ...
      .then((results: GetReportVoyagePortDaily[]) => {
        // Retornamos una Respuesta exitosa.
        return {
          status: HttpStatus.OK,
          message: 'OK',
  ...
  GetTotalByActivityFilterByUserIdAndDateAndType(
    @Headers() headers,
    @Param('userId') userId: number,
  ...
  GetTotalConsumerByActivityFilterByUserIdAndDateAndType(
    @Headers() headers,
    @Param('userId') userId: number,
    @Param('startDate') startDate: string,
    @Param('endDate') endDate: string,
    @Param('typeSummary') typeSummary: string,
  ): Promise<any> {
    // Le asigno el valor al token desde la cabecera.
    // Lo decodifico con otra libreria por problemas jwt-module.
    let headerToken: UserEntity = JwtDecode(headers.authorization);
    ...
    return DummyPromise()
      ...
      .then((results: InfoReport_IFO_AND_MGO) => {
        // Retornamos una Respuesta exitosa.
        return {
          status: HttpStatus.OK,
          message: 'OK',
