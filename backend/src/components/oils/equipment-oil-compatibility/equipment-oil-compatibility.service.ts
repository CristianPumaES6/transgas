...
export class EquipmentOilCompatibilityService {
    ...
    async Gets(equipmentOilCompatibility: EquipmentOilCompatibilityEntity): Promise<EquipmentOilCompatibilityEntity[]> {
        ...
        return DummyPromise().then(
            ...
            (result: EquipmentOilCompatibilityEntity[]) => {
    ...
    async SaveList(MappingOils: Mapping[], MappingEquipmentSystems: Mapping[], equipmentOilCompatibilitys: EquipmentOilCompatibilityEntity[]): Promise<Mapping[]> {


        let MappingConsumptionsEquipment: Mapping[] = [];
        // FIltramos los datos que faltan aggregar y actualizar.
        const addEquipmentOilCompatibilitys = equipmentOilCompatibilitys.filter((equipmentOilCompatibility: EquipmentOilCompatibilityEntity) => equipmentOilCompatibility.SyncStatus == 'added');
        const updateEquipmentOilCompatibilitys = equipmentOilCompatibilitys.filter((equipmentOilCompatibility: EquipmentOilCompatibilityEntity) => equipmentOilCompatibility.SyncStatus == 'updated');
        const deleteEquipmentOilCompatibilitys = equipmentOilCompatibilitys.filter((equipmentOilCompatibility: EquipmentOilCompatibilityEntity) => equipmentOilCompatibility.SyncStatus == 'deleted');
        ...
        for await (const addEquipmentOilCompatibility of addEquipmentOilCompatibilitys) {
            ...
            if (searchMappingOils) { newEquipmentOilCompatibilityEntity.entityOilId = searchMappingOils.value }

            newEquipmentOilCompatibilityEntity.entityEquipmentId = addEquipmentOilCompatibility.entityEquipmentId;
            if (searchMappingEquipmentSystems) { newEquipmentOilCompatibilityEntity.entityEquipmentId = searchMappingEquipmentSystems.value }
        ...
        for await (const updateEquipmentOilCompatibility of updateEquipmentOilCompatibilitys) {
            ...
            if (searchMappingOils) { equipmentOilCompatibility.entityOilId = searchMappingOils.value }

            equipmentOilCompatibility.entityEquipmentId = updateEquipmentOilCompatibility.entityEquipmentId;
            if (searchMappingEquipmentSystems) { equipmentOilCompatibility.entityEquipmentId = searchMappingEquipmentSystems.value }
