...
export class InfoFuelStartEndForDate {
  constructor(public infoFuelStart?: GetROBByUser, public infoFuelEnd?: GetROBByUser) {
...
export class InfoReport_IFO_AND_MGO {
  constructor(public ifo?: GetReportVoyagePortDaily[], public mgo?: GetReportVoyagePortDaily[]) {
    this.ifo = [];
    this.mgo = [];
  }
}
