    ...
    async SaveDataLubricante(headers, saveDateOils) {
        ...
        return promises_assets_1.DummyPromise().then((resultDummy) => {
            ...
            if (listaDeConsumosRegistrados && listaDeConsumosRegistrados.length > 0) {
                return nodemailer_assets_1.SendMailHTMLOverCosumption('cristian.puma.es6@gmail.com; cpuma@transgas.com.pe; hcamasca@transgas.com.pe;', headerToken.name, moment_assets_1.FormatDateUTCToDate(moment_assets_1.GetDate()), listaDeConsumosRegistrados);
            }
            else {
                return true;
            }
