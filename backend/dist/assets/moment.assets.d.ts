...
export declare function ConvertYYYYMMHH_5HorasLOCAL(dateUTC: any, addHour: number): string;
...
export declare function ConvertMMDDYYYYToUTC(dateDDMMYYYY: any): string;
